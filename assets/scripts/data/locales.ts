...
export const locales: LocaleMap = {
  zh: {
    ...
    'ui.tool.foamRoller': '泡沫轴',
    'ui.tool.resistanceBand': '阻力带',
    'ui.tool.foamRoller.desc': '放松髋屈肌',
    'ui.tool.resistanceBand.desc': '激活臀肌',
    'ui.zone.hip': '髋屈肌 (紧张)',
    'ui.zone.glute': '臀肌 (无力)',
    'feedback.correctRelax2': '髋屈肌开始放松了，继续。',
    'feedback.correctStrength2': '臀肌被激活了，骨盆开始稳了。',
    'settlement.desc2': '这位久坐族终于站直了一点',
    'settlement.tip2': '骨盆前倾常见于久坐人群，核心是松髋屈肌、激活臀肌。',
    'hint.title': '康复提示',
    'hint.text':
      '红色区域：太紧了，需要先放松。\n蓝色区域：太弱了，需要把它激活。\n\n记住一句话：松前侧，强后侧。',
    'hint.confirm': '我知道了',
